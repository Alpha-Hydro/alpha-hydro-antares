 ...
 * @author Christian Soronellas <csoronellas@emagister.com>
 */
class Twitter_Bootstrap_Form_Decorator_AddonGroupBtn extends Zend_Form_Decorator_Abstract
{
    ...
    {
        $prepend = $this->getElement()->getAttrib('prepend_btn');
        $append = $this->getElement()->getAttrib('append_btn');
        ...
        if (null !== $prepend) {
            ...
            $prependAddOnClass = 'input-group-btn';
        ...
        if (null !== $append) {
            $placement .= 'input-group ';
            $appendAddOnClass = 'input-group-btn';

            $this->_prepareAddon($append, $appendAddOnClass);
        }

        // Unset the prepend and append data
        $this->getElement()->setAttrib('prepend_btn', null);
        $this->getElement()->setAttrib('append_btn', null);
     ...
     * @param mixed $addon
     */
    protected function _prepareAddon(&$addon, $addonClass)
    {
        if(null === $addonClass)
