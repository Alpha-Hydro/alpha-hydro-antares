...
import CatalogParentCategoryReplaceItemList from "./_catalogParentCategoryReplaceItemList"
import CategoryRaplaceList from "./_categoryRaplaceList";

export default class _categoryReplaceComponent extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			showModal: false,
